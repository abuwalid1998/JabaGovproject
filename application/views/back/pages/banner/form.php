<div class="container">
	...
	<?= form_open_multipart($form_action) ?>
		...
		<div class="form-group row">
			<label for="title" class="col-sm-2 col-form-label">المحتوى</label>
			<div class="col-sm-8">
		...
		<div class="row mt-4">
			<div class="col-8 offset-2">
				<a href="<?= base_url('banner') ?>" class="btn btn-sm btn-secondary"><i class="fas fa-angle-left mr-1"></i>تراجع</a>
