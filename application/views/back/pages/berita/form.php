<div class="container">
	...
	<?= form_open_multipart($form_action) ?>
		...
		<div class="form-group row">
			<label for="content" class="col-sm-2 col-form-label">المحتوى</label>
			<div class="col-sm-10">
		...
		<div class="form-group row">
			<label for="is_active" class="col-sm-2 col-form-label">مفعل</label>
			<div class="col-sm-2">
				<select class="form-control" id="is_active" name="is_active">
					<option value="Y" <?php if($input->is_active == "Y"){ print ' selected'; }?>>نشر</option> 
					<option value="N" <?php if($input->is_active == "N"){ print ' selected'; }?>>نشر لاحقا</option>
				</select>
		...
		<div class="row mt-4">
			<div class="col-10 offset-2">
				<a href="<?= base_url('berita') ?>" class="btn btn-sm btn-secondary"><i class="fas fa-angle-left mr-1"></i>تراجع</a>
