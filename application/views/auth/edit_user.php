      ...
      <div id="content">
        ...
        <!-- End of Topbar -->
			...
			<div class="container">
				<div class="row">
					<div class="col">
						<h3 class="page-header">المعلومات الشخصية</h3>
					</div>
				</div> 
				...
				<div class="form-row ">
					<div class="form-group col-md-4">
						<label for="inputEmail4">الأيميل</label>
				...
				<div class="row">
					<div class="col-8">
						<a href="<?= base_url('admin'); ?>" class="btn btn-secondary btn-sm"><i class="fas fa-angle-left mr-1"></i>تراجع</a>
						<?= form_submit('submit', 'تثبيت التعديلات', ['class' => 'btn btn-primary btn-sm float-right']);?>
