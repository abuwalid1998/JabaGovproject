	...
	public function ajax_list()
   {
	...
	public function add()
	{
		...
		$this->form_validation->set_rules('title', 'العنوان','required',[
			'required' => 'المحتوى tidak boleh kosong!'
			]
		);
		$this->form_validation->set_rules('text', 'المحتوى','required',[
			'required' => 'المحتوى tidak boleh kosong!'
			]
		);

		if($this->form_validation->run() == false){
			$data['title'] 		= 'أضافة جديد Banner';
			...
			$this->session->set_flashdata('success', 'Banner Berhasil Diأضافة جديدkan.');
	...
	public function edit($id)
	{
		...
		$this->form_validation->set_rules('title', 'المحتوى','required',[
			'required' => 'المحتوى tidak boleh kosong!'
			]
		);
		$this->form_validation->set_rules('text', 'المحتوى','required',[
